...
import { updateProfileAction, clearErrors } from '../../redux/actions/userActions'
...
const UpdateProfile = ({ history }) => {
  ...
  }, [dispatch, toastr, error, history, isUpdated])
        ...
        <div className='row wrapper'>
          <div className='col-10 col-lg-5'>
            <form onSubmit={handleSubmit} className='shadow-lg' encType='multipart/form-data'>
              ...
              <button type='submit' className='btn update-btn btn-block mt-4 mb-3' disabled={loading && true}>
                Update
              </button>
            </form>
          </div>
